...
//                firebaseAuthWithGoogle(account.getIdToken());
    ...
    private void checkUserAreadyWhenEmail(String email) {
        ...
        call = RetrofitClient.getApiService(CommunitySignIn.this).searchEmail(email, getString(R.string.appkey));
...
//                            updateUI(null);
    ...
    private void updateTokenInServer(String token) {
        ...
        RetrofitClient.getApiService(CommunitySignIn.this).updateUser(auth.getCurrentUser().getUid(), userModel, getString(R.string.appkey)).enqueue(new Callback<UserModel>() {
            @Override
